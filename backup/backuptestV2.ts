...
describe("nft", () => {
  ...
  it("Mint and transfer!", async () => {
    ...
    const toWallet: anchor.web3.PublicKey = new anchor.web3.PublicKey("9qz923RtkeWQEVCRMz2pAbjnc9F4cWskgw4zuaBRVxMu");
    ...
    const mint_tx = new anchor.web3.Transaction().add(
      ...
      // createAssociatedTokenAccountInstruction(
      //         key, toATA, toWallet, mintKey.publicKey
      //       )
    );
    console.log("2.");
  ...
  //     createAssociatedTokenAccountInstruction(
  //       myWallet, toATA, toWallet, mintKey.publicKey
  //     )
  //   );
